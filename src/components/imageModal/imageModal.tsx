            ...
            >
                ...
                <ModalContent maxW="96rem" h="70rem" mx="16">
                    ...
                    <Flex mx="20px" mt="20px" justify="space-between">
                        ...
                        <Button mr="5px" bgColor="#14387B" color="#FFF"><FiHeart /></Button>
                    </Flex>
                    <Flex justify="space-between" mx="20px">
                        <Text fontSize="4xl">{image.title}</Text>
                        <Text fontSize="4xl">{image.price}€</Text>
                    </Flex>
                    <Text mx="20px" textAlign="justify" mt="2">{image.description}</Text>
                    <Flex>
                        <Text fontWeight="medium" ml="20px" mt="20px">Categoria:</Text>
                        <Text mx="2" mt="20px">{image.category}</Text>
                    </Flex>
                    <Flex>
                        <Text fontWeight="medium" ml="20px" mt="20px">Tipo de Imagem:</Text>
                        <Text mx="2" mt="20px">{image.imageType}</Text>
                    </Flex>
                    <Flex>
                        <Text fontWeight="medium" ml="20px" mt="20px">Ano:</Text>
                        <Text mx="2" mt="20px">{image.year}</Text>
                    </Flex>
